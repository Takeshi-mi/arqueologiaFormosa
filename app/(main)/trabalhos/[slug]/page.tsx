    ...
    <article className="container py-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          <Breadcrumb
            items={[
              ...
              {
                label: trabalho.title,
                href: `/trabalhos/${params.slug}`,
              },
            ]}
          />
        </div>
        ...
        <header className="mb-8">
          <h1 className="text-4xl font-bold mb-6">{trabalho.title}</h1>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 text-muted-foreground">
            ...
            <div className="flex flex-col md:flex-row gap-2">
              ...
              <div className="flex gap-2">
                ...
                <a
                  className="hover:opacity-70"
                  href={`https://api.whatsapp.com/send?text=${trabalho.title}%0A%0A${process.env.NEXT_PUBLIC_SITE_URL}/trabalhos/${params.slug}`}
                  target="_blank"
                  rel="noopener noreferrer"
